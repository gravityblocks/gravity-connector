...
pub mod block_engine_validator_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_block_engine_endpoints(
            &mut self,
            request: impl tonic::IntoRequest<super::GetBlockEngineEndpointRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetBlockEngineEndpointResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod block_engine_validator_server {
    ...
    #[async_trait]
    pub trait BlockEngineValidator: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_block_engine_endpoints(
            &self,
            request: tonic::Request<super::GetBlockEngineEndpointRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetBlockEngineEndpointResponse>,
            tonic::Status,
        >;
    ...
    /// / Validators can connect to Block Engines to receive packets and bundles.
    #[derive(Debug)]
    pub struct BlockEngineValidatorServer<T> {
        inner: Arc<T>,
    ...
    impl<T> BlockEngineValidatorServer<T> {
        pub fn new(inner: T) -> Self {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/block_engine.BlockEngineValidator/GetBlockEngineEndpoints" => {
                    #[allow(non_camel_case_types)]
                    struct GetBlockEngineEndpointsSvc<T: BlockEngineValidator>(
                        pub Arc<T>,
                    );
                    impl<
                        T: BlockEngineValidator,
                    > tonic::server::UnaryService<super::GetBlockEngineEndpointRequest>
                    for GetBlockEngineEndpointsSvc<T> {
                        type Response = super::GetBlockEngineEndpointResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BlockEngineValidator>::get_block_engine_endpoints(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetBlockEngineEndpointsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for BlockEngineValidatorServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "block_engine.BlockEngineValidator";
    impl<T> tonic::server::NamedService for BlockEngineValidatorServer<T> {
...
pub mod block_engine_relayer_server {
    ...
    #[async_trait]
    pub trait BlockEngineRelayer: std::marker::Send + std::marker::Sync + 'static {
    ...
    /// / Block Engines provide an AccountsOfInterest field to only send transactions that are of interest.
    #[derive(Debug)]
    pub struct BlockEngineRelayerServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> BlockEngineRelayerServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for BlockEngineRelayerServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "block_engine.BlockEngineRelayer";
    impl<T> tonic::server::NamedService for BlockEngineRelayerServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
