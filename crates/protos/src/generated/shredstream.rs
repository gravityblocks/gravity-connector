...
pub struct Heartbeat {
    /// don't trust IP:PORT from tcp header since it can be tampered over the
    /// wire `socket.ip` must match incoming packet's ip. this prevents
    /// spamming an unwitting destination
...
pub mod shredstream_proxy_server {
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for
    /// use with ShredstreamProxyServer.
    #[async_trait]
